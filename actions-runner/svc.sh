...
SVC_NAME="actions.runner.jsp-hashicorp-vault-action-example.jsp-C02Z41M0LVDR"
SVC_NAME=${SVC_NAME// /_}
SVC_DESCRIPTION="GitHub Actions Runner (jsp-hashicorp-vault-action-example.jsp-C02Z41M0LVDR)"
